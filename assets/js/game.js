...
var fightOrSkip = function() {
  ...
  if (promptFight === "" || promptFight === null) {
    ...
    // use return to call it again and break the loop
    return fightOrSkip();
  }
...
var startGame = function() {
  ...
  for (var i = 0; i < enemyInfo.length; i++) {
    ...
    if (playerInfo.health >0) {
      ...
      if (playerInfo.health > 0 && i < enemyInfo.length - 1) {
        //ask if plater wants to use the store before next round
  ...
  // if plater is not alive, break out of loop and let endGame function
  else {
